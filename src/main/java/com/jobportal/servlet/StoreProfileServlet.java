...
@WebServlet("/store-profile")
@MultipartConfig
public class StoreProfileServlet extends HttpServlet {

    private static final long serialVersionUID = 123456789L; // ✅ Fixes the warning
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (success) {
            ...
            request.getRequestDispatcher("/jobseeker/create-profile.jsp").forward(request, response);
        }
    }
